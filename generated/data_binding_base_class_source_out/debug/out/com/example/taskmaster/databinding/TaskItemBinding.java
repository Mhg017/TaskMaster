...
public final class TaskItemBinding implements ViewBinding {
  ...
  private TaskItemBinding(@NonNull LinearLayout rootView, @NonNull TextView descriptionTextView,
  ...
  public static TaskItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TaskItemBinding((LinearLayout) rootView, descriptionTextView, titleTextView);
    }
